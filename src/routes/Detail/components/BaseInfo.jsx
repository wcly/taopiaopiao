...
export default function BaseInfo({onShowImage}) {
    return (
        <div className="baseInfo">
            <div className="baseInfo__detail">
                <h3 className="baseInfo__name">唐人街探案2</h3>
                <div className="baseInfo__subTitle">Lorem ipsum dolor sit.</div>
            ...
            <div className="baseInfo__poster" style={{backgroundImage: 'url(/source/movie/asset4.jpeg)'}} onClick={onShowImage}></div>
        </div>
    )
}
